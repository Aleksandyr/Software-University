...
public class EscapeFromLabyrinth
{
    ...
    {
        string shortestPathToExit = FindShortestPatchToExit();
        ...
        {
            Console.WriteLine("Start is at the exti.");
        }
        else
        {
    ...
    //    {
    //        string widthA = Console.ReadLine().Split("[\s*]");
    //        labyrinth[row, width] = Convert.ToChar(Console.ReadLine());
    //    }
    //}
    ...
    static string FindShortestPatchToExit()
    {
